...
6. [Example Fixed SCF Input File]
...
An example [Smear SCF input file](https://github.com/kylayounger/So-You-Want-To-Model-Materials-In-Quantum-Espresso/blob/main/Self-Consistent%20Field%20(SCF)%20Jobs/Smear.in) and Fixed SCF input file are attached for your reference (2x2x2 Tetragonal Barium Titanate Supercell).
